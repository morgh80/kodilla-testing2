...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_SELECT = "//div[contains(@class, \"tasks-container\")]/form/div/fieldset/select[1]git status";
    public static final String XPATH_WAIT_FOR = "//select[1]";

    public static void main(String[] args) {
        WebDriver driver = WebDriverConfig.getDriver(WebDriverConfig.CHROME);
        driver.get("https://morgh80.github.io/");
        ...
        testareaField.sendKeys("New robotic content");
